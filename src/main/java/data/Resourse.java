 ...
 * Класс Resourse содержит в себе данные для ресурсов: информация о странице, количество элементов на странице,
 * общее количество элементов, общее количество страниц, список пользователей, информацию о поддержке.
 */
public class Resourse {
    ...
    /**
     * Сеттер поля total_pages
     * @param data - задаём список пользователей
     */
